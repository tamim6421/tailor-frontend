  ...
  return (
    ...
    data-aos-duration="1000">
      <div className="md:flex space-y-5 w-3/4 mx-auto items-start justify-between">
        ...
        <div>
          <p>
            Adipiscing elit, sed do euismod tempor incidunt ut <br /> labore et
        ...
        <div>
          <button className="flex gap-3 items-center ">
            View More <FaArrowRightLong className="text-orange-500" />{" "}
          </button>
        </div>
      </div>
      ...
      <div className="w-3/4 mt-20 mx-auto">
        ...
        >
          <SwiperSlide>
            <div
              className="relative p-2 w-full cursor-pointer group transition-all duration-500 flex flex-col text-gray-700  bg-white  rounded-xl "
              data-aos="zoom-in-up"
            >
              ...
              <div className="flex justify-center p-2 pt-2 gap-7 ">
                <div className=" absolute gap-4 scale-0 transition-all duration-500 group-hover:scale-100 top-1/2">
                  ...
                  <p className="text-white font-semibold flex gap-4 items-center">
